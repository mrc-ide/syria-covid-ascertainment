...
# pmcmc arguments
n_particles <- 1 # using the deterministic version
replicates <- 100
n_mcmc <- 10000
n_chains <- 3
...
# dam_pop_urban <- 2394090 # https://populationstat.com/syria/damascus
...
# Default taken as 2394000 based on UN Urbanisation estimates
